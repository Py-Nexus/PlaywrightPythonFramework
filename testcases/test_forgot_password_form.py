...
class Test_ForgotPasswordForm:
    ...
    def test_forgot_password_form(self, page, rp_logger):
        try:
            ...
            expected_title = "Forgot Password form page for Automation Testing Practice"
            ...
            expected_p_text = "An e-mail has been sent to you which explains how to reset your password."
            check.equal(p_text, expected_p_text, f"Expected retrieval message 'An e-mail has been sent to you which explains how to reset your password.' but got '{p_text}'")
